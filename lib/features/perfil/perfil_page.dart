...
class _PerfilPageState extends State<PerfilPage> {
  ...
  Widget _buildMenuItem(BuildContext context, IconData icon, String title, String? route, Map<String, dynamic>? args) {
    return Container(
      ...
      child: ListTile(
        leading: Container(padding: const EdgeInsets.all(8), decoration: BoxDecoration(color: greenPrimary.withOpacity(0.1), shape: BoxShape.circle), child: Icon(icon, color: greenPrimary)),
  ...
  Widget _buildLogoutButton(BuildContext context) {
    return SizedBox(
      ...
      child: TextButton(
        style: TextButton.styleFrom(padding: const EdgeInsets.symmetric(vertical: 16), backgroundColor: Colors.red.withOpacity(0.1), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16))),
